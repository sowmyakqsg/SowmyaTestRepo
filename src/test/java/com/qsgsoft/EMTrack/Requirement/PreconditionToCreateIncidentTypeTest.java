...
' Author		    :QSG
'*******************************************************************/
public class PreconditionToCreateIncidentTypeTest{

//Log4j object to write log entries to the Log files
static Logger log4j = Logger.getLogger("com.qsgsoft.EMTrack.features.Req9319");
...
@Test
public void testCreateIncidentType() throws Exception {
	...
	/*
	* STEP :
	  Action:Login to EMTrack
	  Expected Result:verify that ended incident is not displayed on gadget
	*/
	//664216

	try{
		assertEquals("", strFuncResult);
		strFuncResult = objLoginPage.login(selenium, varUserName, varPassword);
	}
