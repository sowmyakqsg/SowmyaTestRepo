...
@Suite.SuiteClasses({
		/*
		 * CreateRegion.class, EditRegion.class,
		 */
		...
		StatusDetailReport.class, StatusReasonDetailRep.class,
		StatusReasonSummaryRep.class, StatusSnapshotReport.class,
		StatusSummaryReport.class, FormDetailReportUpdated.class,
		NewFor3pt15AddStatusTypeToCurrentlyRunningEvent.class,
		StatewideResourceDetailsReport.class,

		InactivateMultiStatType.class, InactivateResourceType.class,
		InactiveNumberStatType.class, InactiveSaturScoreStatType.class,
		InactiveTextStatType.class, CreateStatus.class,
