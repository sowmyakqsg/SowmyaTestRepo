...
EdgeCaseCreateEvent.class, EdgeCaseEditEvent.class,
		EdgeCaseImportUsersAndResources.class, EdgeCaseEditEventTemplate.class,
		...
		EdgeCaseRefineStatusType.class, EdgeCaseHICSNotifications.class,
		EdgeCaseDeleteRole.class, EdgeCaseForgotUserIDOrPassword.class,
