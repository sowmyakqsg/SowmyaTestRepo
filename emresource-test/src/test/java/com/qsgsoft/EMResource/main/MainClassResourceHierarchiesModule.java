...
@Suite.SuiteClasses({
	...
	ResourceSearch.class, CreatingSubResource.class,
	CreatingSubResourceType.class, CreatingAndManagingEvents.class,
	CreatingAndManagingUsers.class, EditingSubResource.class,
