...
HappyDaySwitchUser.class, HappayDayForgotUserIDOrPassword.class,
		HappyDayAssociatingSectionToAstatusType.class, HappyDayEditEvent.class,
		HappyDayCreateEvent.class, HappyDayAddStatusChangePreferences.class,
		HappyDayEventSnapshotReport.class,
		HappyDayEditNEDOCScoreStatusTypes.class,
		HappyDayEventDetailReport.class, HappyDayHelpDocumentation.class,
		...
		HappyDaySettingUpOfRegionViews.class, HappyDayStatusDetailReport.class,
		HappyDayStatusSnapshotReport.class,
		HappyDayImportUsersAndResources.class,
		HappyDayHICSICSNotifications.class, HappyDayDeleteRole.class,
