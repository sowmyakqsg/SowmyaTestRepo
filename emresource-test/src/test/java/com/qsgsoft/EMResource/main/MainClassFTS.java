...
@Suite.SuiteClasses({
		...
		FTSImportUsersAndResources.class, FTSImportUserFromSpreadSheet.class,
		FTSNewFor3pt15_AddStatusTypeToCurrentlyRunningEvent_AutoIT.class,
		FTSCreateEvent_AutoIT.class, FTSCreatingAndManagingUsers_AutoIT.class,
		FTSStatusSnapShotReport_AutoIT.class, FTSCreateAFolder.class,
		FTSRenameFolder.class, FTSDeleteFolder.class, FTSAddADocument.class,
		FTSMoveADocument.class, FTSDeleteADocument.class,
		FTSCreateQuickLlinkForForm.class, FTSStatusDetailReport.class,
