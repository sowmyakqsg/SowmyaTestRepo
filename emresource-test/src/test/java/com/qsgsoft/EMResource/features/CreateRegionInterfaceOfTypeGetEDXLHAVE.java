...
' Requirement Group   :Create Region Interface Of Type GetEDXLHAVE
...
public class CreateRegionInterfaceOfTypeGetEDXLHAVE {
	...
	*****************************************************************************************/
	@Test
	public void testBQS94039() throws Exception {
		...
		try {
			...
			gstrTO = "Verify that a region interface of type" +
					" 'Get EDXL-HAVE 1.0' can be created.";
			gstrResult = "FAIL";
			gstrReason = "";
			...
			/*1Preconditions:No other active interface is present in the region with the
			 *  interface type 'Get EDXL-HAVE 1.0' 		
			 *  No Expected Result 
			...
			try {
				assertEquals("", strFuncResult);
				log4j.info("Under web service Action field '"+strWebServiceAction+"' is displayed by default. ");
			 ...
			 * 'Interface' is created and listed in 'Interface List' screen with 
			 * appropriate values under all the columns.
			...
			gstrTCID = "94039";
			gstrTO = "Verify that a region interface of type 'Get"
					+ " EDXL-HAVE 1.0' can be created.";
			gstrResult = "FAIL";
			log4j.info(e);
			log4j.info("========== Test Case '" + gstrTCID
					+ "' has FAILED ==========");
