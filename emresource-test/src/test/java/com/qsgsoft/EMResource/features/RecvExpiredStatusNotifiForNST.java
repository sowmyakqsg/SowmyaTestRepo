...
/***********************************************************************************************
 * ' Description  :This class includes Receive expired status notifications for NST 'testcases'
 * ' Precondition : 
 * ' Date         :12-June-2012
 * ' Author       :QSG
 * '--------------------------------------------------------------------------------------------'
...
public class RecvExpiredStatusNotifiForNST {
	Date gdtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features.RecvExpiredStatusNotifiForNST");
	static {
	...
	************************************************************************/
	...
	@Test
	public void testBQS66068() throws Exception {
		...
		try {
			...
			gstrTO = "Verify that user receives the following when the"
					+ " number status of a resource expires at the SHIFT"
			...
			try {
				...
				strMsgBody1Another = "For autouser\nRegion: "
						+ strRegn
						+ "\n\nThe "
						+ statTypeName
						+ " status for "
	...
	/*********************************************************************************
	'Description	:Verify that user receives the following when the number status of 
	                 a resource expires at the EXPIRE time:
					1. Status update prompt.
					2. Expired status notification
					1. Status update prompt.
					2. Expired status notification
	...
	***********************************************************************************/
	@Test
	public void testBQS85194() throws Exception {
		try {
			gstrTCID = "BQS-85194"; 
			gstrTO = "Verify that user receives the following when the number "
		...
		log4j.info("~~~~~PRE-CONDITION- " + gstrTCID+ " EXECUTION STARTS~~~~~");
			...
			gstrTCID = "BQS-85194";
			gstrTO = "Verify that user receives the following when the number status of a resource expires " +
