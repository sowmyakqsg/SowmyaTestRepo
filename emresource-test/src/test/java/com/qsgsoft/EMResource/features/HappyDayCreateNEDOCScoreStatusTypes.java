...
' Date					                               Name
'*******************************************************************/
public class HappyDayCreateNEDOCScoreStatusTypes {

	Date dtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features.HappyDay_CreateNEDOCScoreStatusTypes");
	static {
	...
	*****************************************************************************************/
	@Test
	public void testHapyDay119620() throws Exception {
		...
		try {
			gstrTCID = "119620"; // Test Case Id
			gstrTO = "Verify that user can create NEDOC Score status type.";// TO
			gstrReason = "";
			gstrResult = "FAIL";
			Date_Time_settings dts = new Date_Time_settings();
			...
			String statrStatTypeName = "NST1" + strTimeText;
			...
			try {
				...
				try {
					assertTrue(selenium.isTextPresent(statrNEDOCStatTypeName));
					log4j.info("Status type is displayed in create RT page");
				} catch (AssertionError Se) {
					log4j.info("Status type is NOT displayed in create RT page");
					strFuncResult = "Status type is NOT displayed in create RT page";
				}
			...
			try {
				...
				if (strFuncResult.equals("")) {
					log4j.info("Status type " + statrNEDOCStatTypeName
							+ " is displayed at the Edit resource level page. ");
				} else {
					log4j.info("Status type " + statrNEDOCStatTypeName
							+ " is NOT displayed in Edit resource level page.");
					strFuncResult = "Status type " + statrNEDOCStatTypeName
							+ " is NOT displayed in Edit resource level page.";
					gstrReason = strFuncResult;
				}
			} catch (AssertionError Ae) {
