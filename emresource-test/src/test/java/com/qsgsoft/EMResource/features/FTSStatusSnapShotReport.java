...
public class FTSStatusSnapShotReport {
...
/**********************************************************************
'Description    :Verify that status snapshot report cannot be generated 
                 for a user without 'Report - Status Snapshot' right.
'Arguments		:None
'Returns		:None
'Date			:7/30/2012
'Author			:QSG
...
************************************************************************/
	@Test
	public void testFTS3813() throws Exception {
		...
		try {
			gstrTCID = "3813"; // Test Case Id
			gstrTO = " Verify that status snapshot report cannot be generated without entering "
					+ "data in mandatory fields.";// Test Objective
			gstrReason = "";
			gstrResult = "FAIL";
			...
			String statTypeName1 = "AutoSTn1" + strTimeText;
			String statTypeName2 = "AutoSTx2" + strTimeText;
			String statTypeName3 = "AutoSTs3" + strTimeText;
			String statTypeName4 = "AutoSTm4" + strTimeText;
		...
		*/
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objCreateUsers.selectResourceRights(selenium, strResource, true, false, false, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objCreateUsers
						.advancedOptns(
								selenium,
								propElementDetails
										.getProperty("CreateNewUsr.AdvOptn.ReportStatuSnapshot"),
								true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
		...
		/*
		* STEP :
		  Action:Login as user U1, navigate to Reports>>Status Reports>>Status Snapshot
		  Expected Result:'Status Snapshot Report' page is displayed
		*/
		//18384
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objReports.navToStatusSnapshotReport(selenium);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
		...
		/*
		* STEP :
		  Action:Do not select or enter any date in 'Report Date' field and click on 'Generate Report'
		  Expected Result:An error message 'Report date is required.' is displayed.
		...
		*/
		//18385
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objReports.varErrorMsgInsnapShotReppage(selenium);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			try {
		...
		log4j.info("----------------------------------------------------------");
		   ...
		   gstrTCID = "3813";	//Test Case Id	
			gstrTO = " Verify that status snapshot report cannot be generated without entering data " +
	...
	***********************************************************************/
	@Test
	public void testFTS4087() throws Exception {
		...
		Reports objReports = new Reports();
		try {
			gstrTCID = "4087"; // Test Case Id
			gstrTO = " Verify that status snapshot report cannot be generated for a user without"
					+ " 'Report - Status Snapshot' right.";// Test Objective
			gstrReason = "";
			gstrResult = "FAIL";
		...
		/*
		* STEP :
		  Action:Create all four status types number, multi, text, saturation NST, MST, TXT, SST respectively in region RG1.
		  Expected Result:Status types created are listed on the 'Status List Screen'
		*/			
			strFuncResult = objLogin.login(selenium, strLoginUserName,
					strLoginPassword);
		...
		/*
		* STEP :
		  Action:Create resource type RT selecting NST, MST, TXT and SST.
		  Expected Result:No Expected Result
		*/
		//174584
		...
		/*
		* STEP :
		  Action:Create resource RS selecting RT.
		  Expected Result:No Expected Result
		*/
		//174585
			// RS
		...
		/*
		* STEP :
		  Action:Create view V1 selecting NST, MST, TXT and SST.
		  Expected Result:No Expected Result
		*/
		//174586
		...
		/*
		* STEP :
		  Action:Create a user U1 with 
		1. Update status right on resource RS 
		2. Role to update status types NST, MST, TXT and SST.
		3. User U1 who does not have 'Report - Status Snapshot' right.
		  Expected Result:No Expected Result
		*/
		//174587
		...
		/*
		* STEP :
		  Action:Login as U1 and click on 'Reports' tab.
		  Expected Result:Status reports menu is not available.
		*/
		//174600
			try {
				assertEquals("", strFuncResult);
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objReports.chkForStatusReportMenuTab(selenium);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			gstrTCID = "4087";
			gstrTO = "Verify that status snapshot report cannot be generated for a user without 'Report - Status Snapshot' right.";
			gstrResult = "FAIL";
			log4j.info(e);
			log4j.info("========== Test Case '" + gstrTCID
					+ "' has FAILED ==========");
	...
	/***************************************************************
	'Description  :Verify that future date and time are not accepted
	               while generating status snapshot report.
	'Arguments	  :None
	'Returns	  :None
	'Date		  :7/30/2012
	'Author		  :QSG
	...
	***************************************************************/
	...
	@Test
	public void testFTS3816() throws Exception {
		String strFuncResult = "";
		boolean blnLogin = false;
		Login objLogin = new Login();
		StatusTypes objStatusTypes = new StatusTypes();
		...
		try {
			gstrTCID = "3816"; // Test Case Id
			gstrTO = " Verify that future date and time are not accepted while generating status snapshot report.";//TO
			gstrReason = "";
			gstrResult = "FAIL";
			...
			String strTimeFormat1 = "mm";
			String strTimeFormat2 = "HH";
			String strFutureMin = "";
			String strFutureHour = "";
			int intMin = 1;
			int intHour = 1;
		/*
		* STEP :
		...
		*/
			...
			try {
				...
				strFuncResult = objCreateUsers
						.advancedOptns(
								selenium,
								propElementDetails.getProperty("CreateNewUsr.AdvOptn.ReportStatuSnapshot"),
								true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
		...
		*/
		...
		/*
		* STEP :
		  Action:Select a future date from the calender widget for 'Report Date' field and click on 'Generate Report'.
		  Expected Result:An error message 'The report date/time may not be in the future.' is displayed.
				  Report is not generated.
		*/
		//18398			
			try {
				assertEquals("", strFuncResult);
				strFutureDate = dts.FutureDate(intAdd, DateFormat);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				String strMsg="The report date/time may not be in the future.";
				strFuncResult = objReports.varErrorMsgforReportGen(selenium,strFutureDate, strGenTimeHrs, strGenTimeMin,strMsg);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			/*
		* STEP :
		  Action:Select current date and select a future time in 'Hour' and 'Minute' field and click on 'Generate Report'
		  Expected Result:An error message 'The report date/time may not be in the future.' is displayed.
				  Report is not generated.
		*/
		//18399	
			...
			try {
				assertEquals("", strFuncResult);			
				strFutureMin = dts.addTimetoExisting(strGenTimeMin, intMin, strTimeFormat1);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			try {
				assertEquals("", strFuncResult);
				strFutureHour = dts.addTimetoExistingHour(strGenTimeHrs, intHour, strTimeFormat2);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			try {
				assertEquals("", strFuncResult);
				String strMsg="The report date/time may not be in the future.";
				strFuncResult = objReports.varErrorMsgforReportGen(selenium,strGenDate, strFutureHour, strFutureMin,strMsg);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
		...
		gstrTCID = "3816";
		gstrTO = "Verify that future date and time are not accepted while generating status snapshot report.";
		gstrResult = "FAIL";
		log4j.info(e);
		log4j.info("========== Test Case '" + gstrTCID
		+ "' has FAILED ==========");
