...
' Date					Name
'*******************************************************************/
public class EditMultiStatusType {

	Date gdtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features.EditMultiStatusType");
	static {
	...
	@Test
	public void testBQS99001() throws Exception {
		...
		String strStatTypDefn = "AutoDef" + strTimeText;

		String statEdTypeName = "AEd_" + strTimeText;
		String strEdStatTypDefn = "AEdDef" + strTimeText;
		...
		try {
			gstrTCID = "BQS-99001";
			gstrTO = "Verify that a multi status type can be edited.";
			gstrResult = "FAIL";
			gstrReason = "";
			...
			try {
				...
				strFuncResult = objPref.createCustomViewNewWitTablOrMapOption(
						seleniumPrecondition, strArRes, strResrctTypName, statTypeName);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objViews.verifySTNameAndDefInDefnScreen(
						seleniumPrecondition, statTypeName, strStatTypDefn);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objViews.navToUpdateStatusByKey(seleniumPrecondition,
						strResource);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			try {
				...
				strFuncResult = objViews.verifySTNameAndDefnInUpdtStatus(
						seleniumPrecondition, statTypeName, strSTvalue[0], strStatTypDefn);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objViews.fillAndSaveUpdStatusMSTWithComments(
						seleniumPrecondition, strStatusValue[0], strSTvalue[0], "",
						strViewName);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objViews.verifyUpdateST(seleniumPrecondition,
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objST.editStatusTypesMandFlds(seleniumPrecondition,
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objViews.checkStatTypeInCreateView(seleniumPrecondition,
						statEdTypeName);
			...
			try {
				...
				strFuncResult = objViews.checkStatTypeInEditResDetViewSections(
						seleniumPrecondition, statEdTypeName, strSection);
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objRT.navToCreateNewResrcTypePage(seleniumPrecondition);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objGen.checkStatTypeInDiffPage(seleniumPrecondition,
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objRole.navCreateRolePge(seleniumPrecondition);
			...
			try {
				...
				strFuncResult = objELs.checkSTypesEvntBanner(seleniumPrecondition,
			...
			try {
				assertTrue(strFuncResult.equals(""));
				strFuncResult = objEve.navToeditEventPage(seleniumPrecondition, strEveName,
						false);
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objForm.navToFormConfig(seleniumPrecondition);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objForm.navTocreateNewFormTemplate(seleniumPrecondition);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			try {
				...
				strFuncResult = objForm
						.fillAllFieldsInCreateNewFormWitoutPageVef(seleniumPrecondition,
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objForm.checkStatTypeInFormActivationSTPage(
						seleniumPrecondition, statEdTypeName);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			log4j.info("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
			...
			/*
			 * 18 Navigate to 'View >> Custom View' The updated status type is
