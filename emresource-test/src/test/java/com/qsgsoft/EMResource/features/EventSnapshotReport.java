...
public class EventSnapshotReport {
	...
	/*******************************************************************************************
	'Description	:Update statuses of status types added at the resource level for a resource
	'				 RS. Verify that a user with �Run Report� & 'View Resource' rights on RS and
	'				 with a role WITHOUT view/update rights for these status types CANNOT view 
	'				 these status types in the Event Snapshot Report.
	'Precondition	:	Preconditions:

					1. Resource type RT is associated with status type ST1 and NOT with status types NST (Number), MST (Multi), TST (Text) and SST (Saturation Score)
					
					2. Resources RS is created under RT.
					
					3. Status Type NST, MST, TST and SST are added for resource RS at the resource level
					...
					7. Status Type NST, MST, TST and SST are updated on day D1 time hour H1 for resource RS. 		
	'Arguments		:None
	'Returns		:None
	'Date	 		:17-July-2012
	'Author			:QSG
	...
	****************************************************************************************/
	...
	@Test
	public void testBQS118661() throws Exception {
		...
		try {
			gstrTCID = "118661"; // Test Case Id
			gstrTO = "Update statuses of status types added at the resource "
					...
					+ " types in the Event Snapshot Report.";
			...
			String statGeneralTypeName = "ST" + strTimeText;
			...
			try {
				...
				strFuncResult = objStatusTypes.selectStatusTypesAndFilMandFlds(
						seleniumPrecondition, strSTValue, statGeneralTypeName,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strStatValue = objStatusTypes.fetchSTValueInStatTypeList(
						seleniumPrecondition, statGeneralTypeName);
			...
			try {
				...
				String[] strViewRightValue = { strSTvalue[1], strSTvalue[2],
						strSTvalue[3], strSTvalue[4] };
			...
			/*
			 * 3. Status Type NST, MST, TST and SST are added for resource RS at
			 * the resource level
			 */
			...
			try {
				...
				String[] strStatusTypeValue = { strSTvalue[1], strSTvalue[2],
						strSTvalue[3], strSTvalue[4] };
			...
			/*
			 * 7. Status Type NST, MST, TST and SST are updated on day D1 time
			 * hour H1 for resource RS. No
			 */
			...
			try {
				...
				strFuncResult = objViews.fillAndSavUpdateStatusMST(selenium,
						strStatusValue[0],strSTvalue[4], false, "",
						"");
			...
			try {
				...
				String[][] strTestData = {
						...
						{ "Resource Type", "Resource", "Comment",
								"Last Update", "By User" },
						{ strResrctTypName, strResource, "", strTime+" "+strUpdateDataHr + ":"
			...
			try {
				assertEquals("", strFuncResult);
				log4j
						.info("Status types NST, MST, TST and SST are NOT displayed"
								+ " for RS in the generated report. ");

				gstrResult = "PASS";
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
				log4j
						.info("Status types NST, MST, TST and SST are  displayed for "
								+ "RS in the generated report. ");
			}
			...
			gstrTCID = "118661";
			gstrTO = "Update statuses of status types added at the resource level"
					+ " for a resource RS. Verify that a user with �Run Report� & "
					+ "'View Resource' rights on RS and with a role WITHOUT view/update"
					+ " rights for these status types CANNOT view these status types "
					+ "in the Event Snapshot Report.";
			gstrResult = "FAIL";
			log4j.info(e);
	...
	/*******************************************************************************************
	'Description	:Update statuses of status types added at the resource type level for a resource RS. Verify that a user with �Run Report� & 'View Resource' rights on RS and with a role WITHOUT view/update rights for these status types CANNOT view these status types in the Event Snapshot Report.
	'Precondition	:	Preconditions:

					1. Resource type RT is associated with status types NST (Number), MST (Multi), TST (Text) and SST (Saturation Score)
					
					2. Resources RS is created under RT.
					
					3. Event template ET1 is created selecting resource type RT and status types NST, MST, TST, SST
					
					4. Event E1 is created under ET1 selecting resource RS
					...
					6. Status Type NST, MST, TST and SST are updated on day D1 time hour H1 for resource RS		
	'Arguments		:None
	'Returns		:None
	'Date	 		:18-July-2012
	'Author			:QSG
	...
	****************************************************************************************/
	...
	@Test
	public void testBQS118881() throws Exception {
		...
		try {
			gstrTCID = "118881"; // Test Case Id
			gstrTO = "Update statuses of status types added at the resource type "
					+ "level for a resource RS. Verify that a user with �Run Report�"
					+ " & 'View Resource' rights on RS and with a role WITHOUT view/"
					+ "update rights for these status types CANNOT view these status"
					+ " types in the Event Snapshot Report.";
			...
			try {
				...
				gstrReason = strFuncResult;
				log4j.info("Status types NST, MST, TST and SST are  displayed "
						+ "for RS in the generated report. ");
			}
	...
	/*******************************************************************************************
	'Description	:Update statuses of status types added at the resource type level for a resource RS. Verify that a user with �Run Report� & 'View Resource' rights on RS and with a role WITH only view right for these status types CAN view these status types in the Event Snapshot report.
	'Precondition	:	Preconditions:
					...
					a. Report - Event Snapshot
					b. Role to View status types NST (number), MST (multi), TST (text) and SST (saturation score)
					c. 'View Status' and 'Run Report' rights on resources RS.
	...
	****************************************************************************************/
	...
	@Test
	public void testBQS118882() throws Exception {
		...
		try {
			...
			try {
				...
				String[][] strTestData = {
						...
						{ "Resource Type", "Resource", statMultiTypeName,
								...
								"By User" },
						{ strResrctTypName, strResource, strStatusName1,
									"1",
									"393",
									"1", "", strTime + " "+strUpdateDataHr + ":"
									+ strUpdateDataMin, strUserNameUpdate  } };
			...
			try {
				assertEquals("", strFuncResult);
				log4j.info("Status types NST, MST, TST and SST are displayed for RS in the generated report. ");

				gstrResult = "PASS";
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
				log4j.info("Status types NST, MST, TST and SST are NOT displayed for RS in the generated report. ");
			}
	...
	****************************************************************************************/
	...
	@Test
	public void testBQS118662() throws Exception {
		...
		try {
			gstrTCID = "118662"; // Test Case Id
			gstrTO = "Update statuses of status types added at the resource level "
					+ "for a resource RS. Verify that a user with �Run Report� & "
					+ "'View Resource' rights on RS and with a role WITH only view "
					+ "right for these status types CAN view these status types in"
					+ " the Event Snapshot report.";
			...
			try {
				...
				String[] strViewRightValue = {strSTvalue[1],strSTvalue[2],strSTvalue[3],strSTvalue[4]};
				String[] updateRightValue =  {strSTvalue[1],strSTvalue[2],strSTvalue[3],strSTvalue[4]};
				strFuncResult = objRole.CreateRoleWithAllFields(seleniumPrecondition,
						strRoleName, strRoleRights, strViewRightValue, true,
						updateRightValue, true, true);
			} catch (AssertionError Ae) {
			...
			try {
				assertEquals("", strFuncResult);
				strRoleValueView = objRole.fetchRoleValueInRoleList(seleniumPrecondition,
						strRoleName);

				if (strRoleValueView.compareTo("") != 0) {
					strFuncResult = "";
			...
			try {
				assertEquals("", strFuncResult);
/*
				strHr = seleniumPrecondition
						.getValue("//select[@name='startHour']/option/@selected");
				System.out.println(strHr);
				strMin = seleniumPrecondition
						.getValue("//select[@name='startMinute']/option/@selected");
				System.out.println(strMin);
				seleniumPrecondition.click("css=input[value='Save']");
			...
			try {
				...
				strFuncResult = objViewMap
						.updateNumStatusType(selenium, strResource,
								statNumTypeName, strSTvalue[1], "1", "2");
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			...
			try {
				...
				strFuncResult = objViewMap
						.updateNumStatusType(selenium, strResource,
								statTextTypeName, strSTvalue[2], "1", "2");
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			...
			try {
				...
				strFuncResult = objStatusTypes.updateSatuScoreStatusType(
						selenium, strResource, statSaturatTypeName,
						strSTvalue[3], strUpdateValue1, strUpdateValue2, "393",
						"429");
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			...
			try {
				...
				strFuncResult = objStatusTypes.updateMultiStatusType_ChangeVal(
						selenium, strResource, statMultiTypeName,
						strSTvalue[4], strStatusName1, strStatusValue[0],
						strStatusName2, strStatusValue[1]);
			...
			try {
				...
				String strCSTtime = dts.getTimeOfParticularTimeZone("CST",
						"M/d/yyyy");
				strFuncResult = objRep.selectHtmlOrExcelformatInEventSnapShotReport(
						selenium, strCSTtime, strApplTime, strETValue,true);
			...
			try {
				...
				strTimeReport = dts.converDateFormat(strHr + ":"
						+ strMin, "HH:mm", "H:mm");
				...
				System.out.println(strTimeReport);
				strFuncResult = objRep.enterEvntSnapshotGenerateReport(
						selenium, strApplTime, strEventValue, strLastUpdArr[0], strLastUpdArr[1]);
			...
			try {
				...
				String[][] strTestData = {
						...
						{ "Resource Type", "Resource", statMultiTypeName,
								...
								statTextTypeName, "Comment", "Last Update",
								"By User" },
						{ strResrctTypName, strResource, strStatusName1,"1",
									"393",
									"1",
									"",
	...
	/*******************************************************************************************
	'Description	:Add a status type ST back to resource RS and update the status value of ST 
	'				 for RS, generate the �Event Snapshot Report� and verify that the data is 
	'				 displayed appropriately in the report
	'Precondition	:1. Resource type RT1 is associated with status type ST1 and NOT with status types NST (Number), MST (Multi), TST (Text) and SST (Saturation Score)
	...
	'				 6. User U1 has following rights:
					...
					'Update Status' and 'Run Report' rights for resource RS1 		
	'Arguments		:None
	'Returns		:None
	'Date	 		:31-July-2012
	'Author			:QSG
	...
	****************************************************************************************/
	...
	@Test
	public void testBQS118660() throws Exception {
		...
		try {
			gstrTCID = "118660"; // Test Case Id
			gstrTO = "Add a status type ST back to resource RS and update the"
					+ " status value of ST for RS, generate the �Event Snapshot"
			 ...
			 * 6. User U1 has following rights:
			 * 
			 * 'Report - Event Snapshot' Role to update status type NST, MST,
			 * TST and SST 'Update Status' and 'Run Report' rights for resource
			 * RS1
			 */
			...
			try {
				...
				blnLogin=false;
				strFuncResult=objLogin.newUsrLogin(seleniumPrecondition, strUserName_1, strInitPwd);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			/*7. Status Type NST, MST, TST and SST are updated on day D1 time hour H1 for resource RS. 		No */
			...
			try {
				...
				strFuncResult = objViewMap
						.updateNumStatusType(seleniumPrecondition, strResource,
								statNumTypeName, strSTvalue[1], "1", "2");
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			...
			try {
				...
				String[] strUpdateValue2 = { "1", "2", "3", "4", "5", "6", "7",
						"8", "9" };
				strFuncResult = objStatusTypes.updateSatuScoreStatusType(
						seleniumPrecondition, strResource, statSaturatTypeName,
						strSTvalue[3], strUpdateValue1, strUpdateValue2, "393",
						"429");
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			...
			try {
				...
				strFuncResult = objStatusTypes.updateMultiStatusType_ChangeVal(
						seleniumPrecondition, strResource, statMultiTypeName,
						strSTvalue[4], strStatusName1, strStatusValue[0],
						strStatusName2, strStatusValue[1]);
			...
			try {
				...
				strFuncResult =objViewMap.navResPopupWindowNew(seleniumPrecondition, strResource);
			...
			try {
				...
				strLastUpdArr =  seleniumPrecondition.getText(
						"//span[text()='"+strStatusName1+"']" +
						"/following-sibling::span[@class='time'][1]").split(" ");
				strLastUpdArr=strLastUpdArr[2].split(":");
				strUpdateDataHr=strLastUpdArr[0];
			...
			/*
			 * 4 Click on link 'Edit Status Types' 'Edit Resource-Level Status
			 * Types' screen is displayed.
			 */
			/*
			 * 5 Deselect the status type MST and click on 'Save'. 'Resource
			...
			/*
			 * 6 Click on link 'Edit Status Types' 'Edit Resource-Level Status
			 * Types' screen is displayed.
			 */
			/*
			 * 7 Select back status type 'MST' and click on Save 'Resource List'
			 * screen is displayed.
			 */
			...
			/*
			 * 8 Login as user U1, update the statuses of NST, MST, TST and SST
			 * on day D1 time hour H1 for resource RS1. No Expected Result
			 */ 
			try {
				assertEquals("", strFuncResult);
				blnLogin=false;
			...
			/*	
				int intMin=Integer.parseInt(strMin)+5;
			...
			try {
				...
				strApplTime = dts.converDateFormat(strApplTime, "M/d/yyyy",
						"M/d/yyyy");
				String str = "Event Snapshot for " + strEveName + " - "
						+ strApplTime + " "+strLastUpdArr[0]+":"+strLastUpdArr[1]
						+ " Central Standard Time. Event Start:" + " "
						+ strTime + " " + strHr + ":" + strMin
						+ ". Event End: " + strFutureDate + "" + " " + strHr
						+ ":" + strMin + ". ";
				...
				String[][] strTestData = {
						...
						{ strResrctTypName, strResource,strStatusName1,"1",
									...
									"",
									strTime + " " + strUpdateDataHr + ":"
											+ strUpdateDataMin, strUserName_1 } };
			...
			try {
				assertEquals("", strFuncResult);
				log4j.info("Status types NST, MST, TST and SST are "
						+ " displayed for RS in the generated report. ");

				gstrResult = "PASS";
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
				log4j.info("Status types NST, MST, TST and SST are NOT"
						+ " displayed for RS in the generated report. ");
			}
	...
	****************************************************************************************/
	...
	@Test
	public void testBQS118659() throws Exception {
		...
		try {
			 ...
			 * 5. User U1 has following rights:
			 * 
			 * a. Report - Event Snapshot b. Role to update status types
			...
			/*
			 * 4 Navigate to Reports>>Event Reports, click on 'Event Snapshot'.
			 * 'Event Snapshot Report (Step 1 of 2)' screen is displayed with:
			 * 
			...
			try {
				...
				strFuncResult = objRep
						.vrfyElementsInEvntSnapshotGenerateReport2Of2Pge(
								selenium, strEventValue);
