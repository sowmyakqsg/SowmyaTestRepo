...
' Requirement         :Edit region interface of type ''Update Resource Availability''
' Date		          :27-Oct-2012
' Author	          :QSG
'-------------------------------------------------------------------
...
public class EditRegnInterfaceUpdateResourceAvailability {
	Date gdtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features.EditRegnInterfaceUpdateResourceAvailability");
	static {
...
'Precondition		:Interface 'Test Update Resource Availability' of type 'Update Resource Availability'
'					 is created in region RG1 
'Arguments		:None
'Returns		:None
'Date			:10/27/2012
'Author			:QSG
...
***************************************************************/
	...
	@Test
	public void testBQS94044() throws Exception {
		boolean blnLogin = false;
		String strFuncResult = "";
		Login objLogin = new Login();// object of class Login
		Interface objInterface = new Interface();
		...
		try {
			...
			gstrTO = "Verify that a region interface of type 'Update" +
					" Resource Availability' can be edited.";
			gstrReason = "";
			gstrResult = "FAIL";
			...
			/*
			 * 3 Navigate to Setup >> Interfaces,Click on edit link associated
			 * with 'Test Update Resource Availability' interface. 'Edit region
			 * Interface' screen is displayed.
			 * 
			 * Data provided while creating the interface is retained in all the
			 * fields.
			 */
			...
			/*
			 * 4 Edit the mandatory data of interface and click on 'Save'
			 * 'Interface List' screen is displayed.
			 * 
			 * Interface 'Test Update Resource Availability' is displayed under
			 * it with the updated values under appropriate columns.
			 */
			try {
				assertEquals("", strFuncResult);
				String strResId = "Use the EMResource Resource ID";
