...
' Date					                               Name
'*******************************************************************/
public class HappyDayEditNEDOCScoreStatusTypes {
	Date dtStartDate;
	ReadData rdExcel;
    ...
    *************************************************************************************/
	...
	/**************************************************************
	'Description :Verify that user can edit NEDOCS status type.	              
	'Arguments	 :None
	'Returns	 :None
	'Date		 :27/May/2013
	'Author		 :QSG
	...
	***************************************************************/
	@Test
	public void testHapyDay119714() throws Exception {
		...
		ResourceTypes objRT = new ResourceTypes();//object of class ResourcesType
		General objGeneral = new General();//object of class General
		Resources objRs = new Resources();//object of class Resources
		try {
			gstrTCID = "119714"; // Test Case Id
			gstrTO = "Verify that user can edit NEDOCS status type.";// TO
			gstrReason = "";
			gstrResult = "FAIL";
			Date_Time_settings dts = new Date_Time_settings();
			...
			String strNameFormat = rdExcel.readInfoExcel("User_Template", 7,
					14, strFILE_PATH);
			String statrStatTypeName = "NST" + strTimeText;
			String strStatTypDefn = "Automation";
			String strNEDOCValue = "NEDOCS Calculation";
			String statrNEDOCStatTypeName = "NEDOC" + strTimeText;
			String statrNEDOCStatTypeNameEdit = "eNEDOC" + strTimeText;
			String strStatTypDefnEdit = "AutomationEdit";
			...
			try {
				...
				strFuncResult = objStatusTypes.selectStatusTypesAndFilMandFlds(
						seleniumPrecondition, strNEDOCValue, statrStatTypeName,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strSTvalue[0] = objStatusTypes.fetchSTValueInStatTypeList(
						seleniumPrecondition, statrStatTypeName);
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objStatusTypes.selectStatusTypesAndFilMandFlds(
						selenium, strNEDOCValue, statrNEDOCStatTypeName,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				strSTvalue[0] = objStatusTypes.fetchSTValueInStatTypeList(
						selenium, statrNEDOCStatTypeName);
			...
			try {
				assertEquals("", strFuncResult);
				String strEventOnly = "No";
				String strStandardST = "";
				strFuncResult = objStatusTypes.VerifySTAllFieldsInStatList(
						selenium, statrNEDOCStatTypeName, strNEDOCValue,
						strEventOnly, strStandardST, strStatTypDefn);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objStatusTypes.editStatusTypesMandFlds(
						selenium, statrNEDOCStatTypeName,
						statrNEDOCStatTypeNameEdit, strStatTypDefnEdit, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				String strStandardST = "";
				strFuncResult = objStatusTypes.VerifySTAllFieldsInStatList(
						selenium, statrNEDOCStatTypeNameEdit, strNEDOCValue,
						strEventOnly, strStandardST, strStatTypDefnEdit);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				String strElementID = "css=input[name='statusTypeID'][value='"
						+ strSTvalue[0] + "']";
				...
				try {
					assertTrue(selenium
							.isTextPresent(statrNEDOCStatTypeNameEdit));
					log4j.info("Status type " + statrNEDOCStatTypeNameEdit
							+ " is displayed in create " + strResrctTypName
							+ " page");
				} catch (AssertionError Se) {
					log4j.info("Status type " + statrNEDOCStatTypeNameEdit
							+ " is NOT displayed in create " + strResrctTypName
							+ " page");
					strFuncResult = "Status type " + statrNEDOCStatTypeNameEdit
							+ " is NOT displayed in create " + strResrctTypName
							+ " page";
				}
			...
			try {
				...
				try {
					assertTrue(selenium.isTextPresent(statrNEDOCStatTypeNameEdit));
					
					log4j.info("Status type " + statrNEDOCStatTypeName
							+ " is displayed in edit resource level page");
				} catch (AssertionError Se) {
					log4j.info("Status type " + statrNEDOCStatTypeNameEdit
							+ " is NOT displayed in edit resource level page.");
					strFuncResult = "Status type " + statrNEDOCStatTypeNameEdit
							+ " is NOT displayed in edit resource level page";
				}
