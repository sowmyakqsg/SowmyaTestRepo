...
/**********************************************************************
' Description :This class includes test cases to Inactivate and reactivate number Status types
' Precondition:
' Functions: testBQS69197(),testBQS66229()
' Date		  :08-May-2012
' Author	  :QSG
'-------------------------------------------------------------------
...
' <Date>                           	         <Name>
'*******************************************************************/
public class InactiveNumberStatType {

	static Logger log4j = Logger.getLogger("com.qsgsoft.EMResource.InactiveNumberStatType");
	static {
	...
	************************************************************************/
	@Test
	public void testBQS69197() throws Exception {
		...
		try {
			...
			String[] strRoleStatType = { statrNumTypeName, strStatType1 };
			...
			try {
				...
				try {
					...
					log4j.info("Resource " + strResource
							...
							+ " along with " + statrNumTypeName + " in view "
							+ strViewName + " screen");
					intResCnt++;
				} catch (AssertionError Ae) {
					log4j.info("Resource " + strResource
	...
	/***********************************************************************
	'Description	:Verify that a number status type can be reactivated.
	'Precondition	: 1. Test user has created a number status type 'NST'
					2. Resource Type 'RT' is associated with 'NST' and a resource 'RS' is created under 'RT'
					3. User 'A' has update right on 'RS' and is assigned a role which has update right on 'NST'
					4. View 'V1' is created selecting 'NST' and 'RS'
	...
	************************************************************************/
	@Test
	public void testBQS69229() throws Exception {
		String strFuncResult = "";
		try {
			gstrTCID = "69229";
			gstrTO = "Verify that a number status type can be reactivated.";
			gstrReason = "";
			gstrResult = "FAIL";
