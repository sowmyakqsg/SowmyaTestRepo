...
' Requirement         :EditRegionInterfaceOfTypeUpdateCADStatus
' Date		          :20-Oct-2012
' Author	          :QSG
'-----------------------------------------------------------------
...
public class EditRegionInterfaceOfTypeUpdateCADStatus {
	Date gdtStartDate;
	ReadData rdExcel;
...
***************************************************************/
	...
	@Test
	public void testBQS94126() throws Exception {
		...
		try {
			gstrTCID = "94126"; // Test Case Id
			gstrTO = " Verify that a region interface of type 'Update "
					+ "CAD Status' can be edited."; // Objective
			gstrReason = "";
			gstrResult = "FAIL";
			Date_Time_settings dts = new Date_Time_settings();
			gstrTimetake = dts.timeNow("HH:mm:ss");
			...
			/*
			 * STEP : Action:Preconditions: Interface 'Test Update CAD Status'
			 * of type 'Update CAD Status' is created in region RG1 Expected
			 ...
			 * associated with 'Test Update CAD Status' interface. Expected
			...
			/*
			 * STEP : Action:Edit the mandatory data of interface and click on
			 * 'Save' Expected Result:'Interface List' screen is displayed.
			 * Interface 'Test Update CAD Status' is displayed under it with the
			 * updated values under appropriate columns.
			 */
			// 559454
			try {
				assertEquals("", strFuncResult);
			...
			gstrTCID = "BQS-94126";
			gstrTO = "Verify that a region interface of type 'Update CAD Status' can be edited.";
			gstrResult = "FAIL";
			log4j.info(e);
			log4j.info("========== Test Case '" + gstrTCID
					+ "' has FAILED ==========");
