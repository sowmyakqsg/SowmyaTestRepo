...
' Requirement Group   :CreateRegnInterfaceUpdateResourceAvailability
...
public class CreateRegnInterfaceUpdateResourceAvailability {

	Date gdtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features." +
					"CreateRegnInterfaceUpdateResourceAvailability");
	static {
...
**********************************************************************************/
	@Test
	public void testBQS94043() throws Exception {
		...
		try {
			gstrTCID = "94043";
			gstrTO = "Verify that a region interface of type 'Update Resource " +
			...
			String strWebServiceAction="postResourceStatus";
			String strType="Update Resource Availability";
			String strSchema="ResourceAvailability 1.1";
			String strDesc="Automation";
			String strContactInfo="QSG";
			...
			/*1 Preconditions:No other active interface is present in the region with the 
			 * interface type 'Update Resource Availability'
			 * No Expected Result */	
			/*
				...
				try {
					assertTrue(selenium
							.isElementPresent("//div[@id='mainContainer']/table/tbody/tr/td[2][text()='"
									+ interfaceNameExixting + "']"));
					log4j.info(interfaceNameExixting
							+ "  listed in the Interface list");

				} catch (AssertionError Ae) {
					log4j.info(interfaceNameExixting
							+ " NOT listed in the Interface list" + Ae);
					gstrReason = interfaceNameExixting
							+ " NOT listed in the Interface list" + Ae;
			...
			/*
			 * 4 Click on 'Create New Interface' button,Select 'Update Resource
			 * Availability' from the drop down and click on next 'Create Region
			 * Interface' screen is displayed.
			 * 
			 * Under web service Action field 'postResourceStatus' is displayed
			 * by default.
			 * 
			 * 'Required Status Type Mappings' section is displayed with list of
			 * status type (Multi) checked by default and is disabled.
			 */
			...
			/*
			 * 5 Fill the mandatory data and select Active check box click on
			 * save. 'Interface' is created and listed in 'Interface List'
			 * screen with appropriate values as provided while creating
			 * interface under all the columns.
			 */

			try {
				assertEquals("", strFuncResult);
				log4j.info("'Required Status Type Mapping' sections are displayed "
				...
				strFuncResult = "'Required Status Type Mapping' sections is NOT displayed "
						+ "with list of status types (Number status types) and "
						+ "check box corresponding to each status types. ";
				gstrReason = strFuncResult;
				log4j.info("'Required Status Type Mapping' and "
