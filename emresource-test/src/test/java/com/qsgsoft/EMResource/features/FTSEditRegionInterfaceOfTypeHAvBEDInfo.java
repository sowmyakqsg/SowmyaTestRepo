...
public class FTSEditRegionInterfaceOfTypeHAvBEDInfo {
	Date gdtStartDate;
	ReadData rdExcel;
	...
	//start//testFTS67104//
	/**************************************************************************************************
	'Description	:Verify that all the resources in the region are displayed under 'Allowed Resources'
	              section in the 'Create Interface' screen of 'Get Havbed 2.5.2 Information' information.
	'Precondition	:
	'Arguments		:None
	'Returns		:None
	'Date			:8/13/2013
	...
	****************************************************************************************************/
	...
	@Test
	public void testFTS67104() throws Exception {
		...
		try {
			gstrTCID = "67104"; // Test Case Id
			gstrTO = " Verify that all the resources in the region are displayed under" +
					" 'Allowed Resources' section in the 'Create Interface' screen of " +
					"'Get Havbed 2.5.2 Information' information.";//TO
			gstrReason = "";
			gstrResult = "FAIL";
			 ...
			 * 'Create Interface' screen of 'Get Havbed 2.5.2 Information'.
			 */
			// 397459
			...
			try {
				...
				strFuncResult = objResources.createResource_FillAllFields(
						selenium, strResource1, strAbbrv, strResType,
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objInterface.selectAndDeselectResInInterface(
						selenium, strResource2, strRSValue[1], true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			gstrTCID = "FTS-67104";
			gstrTO = "Verify that all the resources in the region are displayed under 'Allowed Resources' section in the 'Create Interface' screen of 'Get Havbed 2.5.2 Information' information.";
			gstrResult = "FAIL";
			log4j.info(e);
			log4j.info("========== Test Case '" + gstrTCID
					+ "' has FAILED ==========");
