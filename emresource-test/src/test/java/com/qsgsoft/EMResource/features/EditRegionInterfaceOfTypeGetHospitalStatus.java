...
public class EditRegionInterfaceOfTypeGetHospitalStatus {
	Date gdtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features.EditRegionInterfaceOfTypeGetHospitalStatus");
	static {
...
***************************************************************/
	...
	@Test
	public void testBQS101821() throws Exception {
		boolean blnLogin = false;
		String strFuncResult = "";
		Login objLogin = new Login();// object of class Login
		Interface objInterface = new Interface();
		...
		try {
			...
			gstrTO = " Verify that a region interface of type " +
					"'Get Hospital Status' can be edited.";
			gstrReason = "";
			gstrResult = "FAIL";
			...
			/*
			 * STEP : Action:Preconditions: Interface 'Test Get Hospital Status'
			 * of type 'Get Hospital Status' is created in region RG1 Expected
			...
			gstrTCID = "BQS-101821";
			gstrTO = "Verify that a region interface of type 'Get Hospital Status' can be edited.";
			gstrResult = "FAIL";
			log4j.info(e);
			log4j.info("========== Test Case '" + gstrTCID
					+ "' has FAILED ==========");
