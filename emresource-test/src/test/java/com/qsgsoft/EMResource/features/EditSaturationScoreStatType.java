...
public class EditSaturationScoreStatType {

	Date gdtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features.EditSaturationScoreStatType");
	static {
	...
	@Test
	public void testBQS99002() throws Exception {
		...
		try {
			...
			try {
				...
				strFuncResult = objPref.createCustomViewNewWitTablOrMapOption(selenium, strArRes,
			...
			try {
				...
				strFuncResult = objViews.verifyUpdateST(selenium,
						strResrctTypName, statTypeName, strScUpdValCheck1);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
