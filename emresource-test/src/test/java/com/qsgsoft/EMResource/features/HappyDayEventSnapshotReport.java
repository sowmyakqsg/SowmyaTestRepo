...
' Date					                                Name
'*******************************************************************/
public class HappyDayEventSnapshotReport {
	Date dtStartDate;
	ReadData rdExcel;
	static Logger log4j = Logger
			.getLogger("com.qsgsoft.EMResource.features.HappyDay_EventSnapshotReport");
	static {
	...
	'Precondition	:	Create 8 Status type TST,NST ,SST,MST,eTST,eNST ,eSST,eMST,
	'Arguments		:None
	'Returns		:None
	'Date	 		:6-May-2013
	'Author			:QSG
	...
	****************************************************************************************/	
	@Test
	public void testHapyDay118562() throws Exception {		
		String strFuncResult="";
		boolean blnLogin=false;		
		Paths_Properties objAP = new Paths_Properties();//object of class Paths_Properties
		Properties pathProps = objAP.Read_FilePath();//object of class Read_FilePath
		Login objLogin = new Login();// object of class Login
		ViewMap objViewMap=new ViewMap();
		Reports objRep=new Reports();//object of class Reports
		StatusTypes objStatusTypes=new StatusTypes();//object of class StatusTypes
		ResourceTypes objRT = new ResourceTypes();//object of class ResourcesTypes
		...
		try {
			...
			String statNedocTypeName="NEDOC"+strTimeText;			
			String statNumTypeName_Event="eNST"+strTimeText;
			String statTextTypeName_Event="eTST"+strTimeText;
			String statMultiTypeName_Event="eMST"+strTimeText;
			String statSaturatTypeName_Event="eSST"+strTimeText;
			String statNedocTypeName_Event="eNedoc"+strTimeText;			
			...
			String strStatusName1_Event="Eta"+strTimeText;
			String strStatusName2_Event="Etb"+strTimeText;
			String strStatusValue_Event[]=new String[2];
			strStatusValue_Event[0]="";
			strStatusValue_Event[1]="";
			String strStatusValue[]=new String[2];
			strStatusValue[0]="";
			strStatusValue[1]="";			
			//General variable 
			String strStatValue = "";		
			String strSTvalue[]=new String[10];
			...
			String strUpdate3="393";
			String strUpdate4=strStatusName2;			
			String strUpdate5="102";
			String strUpdate6="Update6";
			String strUpdate7="429";
			String strUpdate8=strStatusName2_Event;			
			String strUpdate9="135";
			String strUpdate10="241";
			...
			try {
				...
				strFuncResult = objStatusTypes.selectStatusTypesAndFilMandFlds(
						seleniumPrecondition, strNEDOCValue, statNedocTypeName,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
	...
	/******************************************************************************************/		
			...
			try {
				...
				strFuncResult = objStatusTypes.createEventSTWitMandFlds(
						seleniumPrecondition, strNSTValue, statNumTypeName_Event,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objStatusTypes.createEventSTWitMandFlds(
						seleniumPrecondition, strTSTValue, statTextTypeName_Event,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objStatusTypes.createEventSTWitMandFlds(
						seleniumPrecondition, strSSTValue, statSaturatTypeName_Event,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objStatusTypes.createEventSTWitMandFlds(
						seleniumPrecondition, strMSTValue, statMultiTypeName_Event,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objStatusTypes.createSTWithinMultiTypeST(
						seleniumPrecondition, statMultiTypeName_Event, strStatusName1_Event, strMSTValue,
						strStatTypeColor, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				strFuncResult = objStatusTypes.createSTWithinMultiTypeST(
						seleniumPrecondition, statMultiTypeName_Event, strStatusName2_Event, strMSTValue,
						strStatTypeColor, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				strStatValue = objStatusTypes.fetchStatValInStatusList(
						seleniumPrecondition, statMultiTypeName_Event, strStatusName1_Event);
				if (strStatValue.compareTo("") != 0) {
					strFuncResult = "";
					strStatusValue_Event[0] = strStatValue;
				} else {
					strFuncResult = "Failed to fetch status value";
				}
			...
			try {
				assertEquals("", strFuncResult);
				strStatValue = objStatusTypes.fetchStatValInStatusList(
						seleniumPrecondition, statMultiTypeName_Event, strStatusName2_Event);
				if (strStatValue.compareTo("") != 0) {
					strFuncResult = "";
					strStatusValue_Event[1] = strStatValue;
				} else {
					strFuncResult = "Failed to fetch status value";
				}
			...
			try {
				...
				strFuncResult = objStatusTypes.createEventSTWitMandFlds(
						seleniumPrecondition, strNEDOCValue, statNedocTypeName_Event,
						strStatTypDefn, true);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
		...
		/***********************************************************************************/
			...
			try {
				...
				String[] strViewRightValue = {strSTvalue[0],strSTvalue[1],strSTvalue[2],
						strSTvalue[3],strSTvalue[4],strSTvalue[5],strSTvalue[6],strSTvalue[7],strSTvalue[8],strSTvalue[9]};
				String[] updateRightValue =  {strSTvalue[0],strSTvalue[1],strSTvalue[2],
						strSTvalue[3],strSTvalue[4],strSTvalue[5],strSTvalue[6],strSTvalue[7],strSTvalue[8],strSTvalue[9]};
		...
		log4j.info("~~~~~PRE-CONDITION " + gstrTCID
			...
			try {
				...
				String[] strRoleStatType = { statMultiTypeName,
						statNumTypeName, statSaturatTypeName, statTextTypeName,statNedocTypeName, statMultiTypeName_Event,
						statNumTypeName_Event, statSaturatTypeName_Event, statTextTypeName_Event  ,statNedocTypeName_Event};
			...
			try {
				...
				String[] strUpdateValue1 = { "0", "1", "2", "3", "4", "5", "6",
						"7", "8" };
				strFuncResult = objViews.fillAndSavUpdateStatusSST(selenium, strUpdateValue1, strSTvalue[2]);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				assertEquals("", strFuncResult);
				String[] strUpdateValue1 = { "0", "1", "2", "3", "4", "5", "6" };
				strFuncResult = objViews.fillUpdateNEDOCSTAndSave(selenium, strUpdateValue1, strSTvalue[4], false);
			...
			try {
				...
				strFuncResult = objViews.fillAndSavUpdateStatusSST(selenium, strUpdateValue2, strSTvalue[7]);
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objViews.fillAndSavUpdateStatusMST(selenium,
						strStatusValue_Event[1], strSTvalue[8], false, "", "");
			} catch (AssertionError Ae) {
				gstrReason = strFuncResult;
			}
			...
			try {
				...
				strFuncResult = objViews.fillUpdateNEDOCSTAndSave(selenium, strUpdateValue1, strSTvalue[9], true);
			...
			try {
				...
				strLastUpdArr =  selenium.getText(
						"//span[text()='"+strStatusName2_Event+"']" +
			...
			try {
				...
				String strPresentTime[] = objGeneral.getSnapTime(selenium);
				int intTimeDiff = dts.getTimeDiffWithTimeFormatInOurTime(
						strPresentTime[2] + ":" + strPresentTime[3], str,
						"HH:mm", 60000);
				if ((intTimeDiff) > 0) {
					intTimeDiff = intTimeDiff * 60 * 1000;
					Thread.sleep(intTimeDiff);
				}else if(intTimeDiff ==0){
			...
			try {
				...
				String[][] strTestData = {
						{ str, "", "", "", "", "", "", "", "", "", "", "", "","","" },
						{ "Resource Type", "Resource", statMultiTypeName_Event ,statNedocTypeName_Event,
								statNumTypeName_Event,
								statSaturatTypeName_Event,
								statTextTypeName_Event, statMultiTypeName,
								statNedocTypeName,statNumTypeName, statSaturatTypeName,
	...
	****************************************************************************************/	
	@Test
	public void testHapyDay118561() throws Exception {		
		String strFuncResult="";
		boolean blnLogin=false;		
		Paths_Properties objAP = new Paths_Properties();
		Properties pathProps = objAP.Read_FilePath();
	...
	/******************************************************************************************/		
		...
		/***********************************************************************************/
			...
			try {
				String strArrSTvalue[]={strSTvalue[1],strSTvalue[2],strSTvalue[3],strSTvalue[4],strSTvalue[5],strSTvalue[6],strSTvalue[7],strSTvalue[8],strSTvalue[9]};
				assertEquals("", strFuncResult);

				for (int i = 0; i < strArrSTvalue.length; i++) {
					strFuncResult = objRT.selAndDeselSTInEditRT(seleniumPrecondition,
							strArrSTvalue[i], true);
				}
			...
			/*4. Event template ET1 is created selecting resource type RT and status types NST, MST, TST, SST,Nedoc*/
			...
			try {
				...
				String[] strResTypeValue = { strRTValue };
				String[] strSTvalues={strSTvalue[0],strSTvalue[1],strSTvalue[2],strSTvalue[3],strSTvalue[4],strSTvalue[5],strSTvalue[6],strSTvalue[7],strSTvalue[8],strSTvalue[9]};
				strFuncResult = objEventSetup.CreateETBySelctngRTAndST(
						seleniumPrecondition, strTempName, strTempDef, true,
			...
			try {
				...
				String strHeaderName[] = { strResrctTypName,
						statMultiTypeName_Event,statNedocTypeName_Event, statNumTypeName_Event,
						statSaturatTypeName_Event, statTextTypeName_Event,
						statMultiTypeName,statNedocTypeName, statNumTypeName,
			...
			try {
				...
				String[][] strDataDouble = {						
						{ statNumTypeName_Event,strUpdate5},			
						{ statNumTypeName, strUpdate1 },};
				strFuncResult = objRep
	...
	/***********************************************************************
	'Description	:Verify that Event Snapshot report displays appropriate
	...
	************************************************************************/	
	@Test
	public void testHapyDay119794() throws Exception {		
		String strFuncResult="";
		boolean blnLogin=false;
		...
		try {
			...
			try {
				...
				String[][] strTestData = {
						{ str, "", "", "", "", "", "", "", "", "", "", "", "" },
						{ "Resource Type", "Resource", statNDSTypeName,
								"Comment", "Last Update", "By User" },
						{
								strResrctTypName,
								strResource,
			...
			try {
				assertEquals("", strFuncResult);
				strTime = dts.converDateFormat(strApplTime, "M/d/yyyy",
						"dd MMM yyyy");
				String strFutureDate = dts.DaytoExistingDate(strTime, 1,
						"dd MMM yyyy");
				strApplTime = dts.converDateFormat(strApplTime, "M/d/yyyy",
			...
			try {
				assertEquals("", strFuncResult);
				String strHeaderName[] = { strResrctTypName,statNDSTypeName,
						"Comment", "Last Update", "By User" };
				strFuncResult = objRep.verifyHeadersInHTMLEventSnapshotReport(
						selenium, strHeaderName);
			} catch (AssertionError Ae) {
			...
			String[] strData=new String[]{strResource,strUpdate1
					,"�",
					strTime + " " + strUpdateDataHr + ":"
							+ strUpdateDataMin, strUsrFulName_1 } ;
			try {
